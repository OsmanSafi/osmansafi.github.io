function OrbitCamera(input) {
    ...
    this.update = function (dt, secondsElapsedSinceStart) {
        ...
        var earthPosition = new Vector4(Math.cos(time.secondsElapsedSinceStart), 3.5, Math.sin(time.secondsElapsedSinceStart), 1); 
    

        if(input.e){
            this.lookAt(earthPosition, new Vector4(0, 0, 0, 1)); 
        }
